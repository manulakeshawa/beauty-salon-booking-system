            ...
            switch (action.toLowerCase()) {
                ...
                case "register":
                    ...
                    if (name != null && email != null && password != null
                            && specialty != null && level != null) {
                        
                        // Generates the 4000-block ID right before saving
                        int newId = stylistFileManager.generateNextStylistId();

                        Stylist stylist = new Stylist(
                                newId, // FIXED: Now strictly uses the new auto-generated ID!
                                name,
                                email,
                                password,
                                specialty,
